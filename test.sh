...
# Invalid Arguments
printf "Invalid Case 1: " && ./philo                            >/dev/null 2>&1 && print_ng || print_ok
printf "Invalid Case 2: " && ./philo 5                          >/dev/null 2>&1 && print_ng || print_ok
printf "Invalid Case 3: " && ./philo 3 3 3                      >/dev/null 2>&1 && print_ng || print_ok
printf "Invalid Case 4: " && ./philo 100 -100 100 100           >/dev/null 2>&1 && print_ng || print_ok
printf "Invalid Case 5: " && ./philo 0 100 100 100              >/dev/null 2>&1 && print_ng || print_ok
printf "Invalid Case 6: " && ./philo 10 10 10 99999999999999999 >/dev/null 2>&1 && print_ng || print_ok
printf "Invalid Case 7: " && ./philo -99999999999999999 2 3 4   >/dev/null 2>&1 && print_ng || print_ok
printf "Invalid Case 8: " && ./philo 201 2 3 4                  >/dev/null 2>&1 && print_ng || print_ok
printf "Invalid Case 9: " && ./philo 200 2 2 100a               >/dev/null 2>&1 && print_ng || print_ok



# Basic Tests
printf "./philo 1 800 200 200: \n"       &&  ./philo 1 800 200 200           2>&1 | tail -1
printf "./philo 4 800 200 200: \n"       &&  ./philo 4 800 200 200           2>&1 | tail -1
printf "./philo 4 410 200 200: \n"       &&  ./philo 4 410 200 200           2>&1 | tail -1
printf "./philo 4 410 200 200 6: \n"     &&  ./philo 4 410 200 200 6         2>&1 | tail -1
printf "./philo 5 800 200 200: \n"       &&  ./philo 5 800 200 200           2>&1 | tail -1
printf "./philo 5 800 200 200 6: \n"     &&  ./philo 5 800 200 200 6         2>&1 | tail -1
printf "./philo 5 310 100 100: \n"       &&  ./philo 5 310 100 100           2>&1 | tail -1
printf "./philo 5 310 100 100 6: \n"     &&  ./philo 5 310 100 100 6         2>&1 | tail -1
...
printf "Dead Case 5: \n"               &&  ./philo 2 400 200 300           2>&1 | tail -1
...
printf "Extreme Alive Case 9: \n"      &&  ./philo 2 500 200 300 10        2>&1 | tail -1
